...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\fprocessed_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\vprocessedAt2\xae\x01\n" +
	"\x0ePaymentService\x12I\n" +
	"\x0eProcessPayment\x12\x1a.payment.v1.PaymentRequest\x1a\x1b.payment.v1.PaymentResponse\x12Q\n" +
	"\fListPayments\x12\x1f.payment.v1.ListPaymentsRequest\x1a .payment.v1.ListPaymentsResponseB;Z9github.com/Bleuble/my-grpc-generated/payment/v1;paymentv1b\x06proto3"
...
var file_payment_v1_payment_proto_depIdxs = []int32{
	3, // 0: payment.v1.ListPaymentsResponse.payments:type_name -> payment.v1.PaymentResponse
	4, // 1: payment.v1.PaymentResponse.processed_at:type_name -> google.protobuf.Timestamp
	2, // 2: payment.v1.PaymentService.ProcessPayment:input_type -> payment.v1.PaymentRequest
	0, // 3: payment.v1.PaymentService.ListPayments:input_type -> payment.v1.ListPaymentsRequest
	3, // 4: payment.v1.PaymentService.ProcessPayment:output_type -> payment.v1.PaymentResponse
	1, // 5: payment.v1.PaymentService.ListPayments:output_type -> payment.v1.ListPaymentsResponse
